...
module.exports = class GreetWelcomeMessageCommand extends Command {

    /**
     * GreetWelcomeMessageCommand constructor
     *
     * @author Kay <kylrs00@gmail.com>
     * @since r20.2.0
     */
    constructor() {
        super("greetwelcomemessage", "Set the greeting welcome message (for after !am).", "gagbot:greet:set", false, [str]);
    }

    /**
     * Set the guild's greeting welcome message in the database.
     *
     * @author Kay <kylrs00@gmail.com>
     * @since r20.2.0
     *
    ...
    async execute(client, message, args) {
        ...
        doc.data.greet.welcomemessage = args.get(0);
        ...
        await doc.save(function(err) {
            ...
            message.channel.send('Greeting welcome message set.');
        });
