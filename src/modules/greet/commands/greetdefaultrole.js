...
module.exports = class GreetDefaultRoleCommand extends Command {
     ...
     */
    constructor() {
        super("greetdefaultrole", "Set the default member role all members get upon joining.", "gagbot:greet:set", false, [role]);
    }

    /**
     * Set the role to grant to members when they join the server.
     *
     * @author Kay <kylrs00@gmail.com>
     * @since r20.2.0
     *
    ...
    async execute(client, message, args) {
        ...
        doc.data.greet.default_role = args.get(0);
